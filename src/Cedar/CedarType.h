...
typedef struct IKE_ATTRIBUTE_HEADER IKE_ATTRIBUTE_HEADER;
...
typedef struct IKE_DATA_ATTRIBUTE IKE_DATA_ATTRIBUTE;
typedef struct IKE_PACKET_ATTRIBUTE_PAYLOAD IKE_PACKET_ATTRIBUTE_PAYLOAD;
